...
import academy.devdojo.auth.security.filter.JwtUserAuthenticationFilter;
...
public class SecurityCredentialsConfig extends SecurityTokenConfig {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.addFilter(new JwtUserAuthenticationFilter(authenticationManager(), jwtConfiguration, tokenCreator))
